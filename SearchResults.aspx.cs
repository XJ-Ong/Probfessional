    ...
    public partial class SearchResults : System.Web.UI.Page
    {
        ...
        private void PerformSearch(string searchTerm)
        {
            ...
            try
            {
                ...
                // Search in Lessons
                string lessonQuery = @"SELECT l.ID as LessonID, l.Title as LessonTitle, m.Title as ModuleTitle FROM Lessons l INNER JOIN Modules m ON l.ModuleID = m.ID WHERE l.Title LIKE @SearchTerm";
